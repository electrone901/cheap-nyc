...
router.put('/:foodId', passport.authenticate('jwt', {session: false}),
    [
        body('name')
            .trim()
            .isLength({min: 2, max: 30})
...
router.delete('/:foodId/comment/:commentId', passport.authenticate('jwt', {session: false}), foodController.deleteComment);
